...
public class CombineProposition extends RequirementProposition{
	...
	public void fuzzilize(Solution s, int index) {
		...
		if(index == 0) {
			...
			//System.out.print(s.getObjective(0) + " : " + original1 + "\n");
			
					//org.sas.benchmark.pw.nrp.Parser.factory.normalize(s.getObjective(1),1);
			// v = (1.0+beta) * o2 + (0-beta) * o1;// + (new java.util.Random().nextGaussian() * dd);
			//double g = (max - min) * new java.util.Random().nextGaussian();
		    //v1 = o1 + beta * o2; //Math.sqrt(o1), *o1
		    //v2 = o1 - beta * o2;
		    //System.out.print(o1 + " value " + s.getObjective(0) +"**\n");
			//System.out.print(o2 + " value " + s.getObjective(1) +"**\n");
			// v = (1.0+beta) * o2 + (0-beta) * o1;// + (new java.util.Random().nextGaussian() * dd);
		    // v = o2 + beta * o1;
			if(o1 == 1) {
